var n = (_, o, t) =>
  new Promise((s, e) => {
    var a = (l) => {
      ...
      i = (l) => (l.done ? s(l.value) : Promise.resolve(l.value).then(a, h));
    i((t = t.apply(_, o)).next());
  });
import {
...
export default class y {
  ...
  getShelvedBooks() {
    return n(this, null, function* () {
      ...
      if (
        ...
        (this.bookShelf = yield u(this.storageKey)),
  ...
  displayBooksFromShelf(o) {
    return n(this, null, function* () {
      ...
      for (const s of this.bookShelf) {
        this.book = yield g.findBookById(s.id, !1);
        try {
        ...
        if (
          ...
          this.book.volumeInfo.ratingsCount == 1
            ? (e = " Review")
            : (e = " Reviews"),
            (this.reviews = this.book.volumeInfo.ratingsCount + e);
        ...
        this.book.volumeInfo.previewLink
          ...
          (this.starRating = v(this.book.volumeInfo.averageRating)),
          this.bookCount++,
          (o.innerHTML += this.renderBookDetails()),
      ...
      e.textContent == "Remove"
        ...
        e.addEventListener("click", () =>
          n(this, null, function* () {
            ...
            this.alterShelf(a, "reading-shelf");
          })
        );
    }),
      ...
      document.querySelectorAll(".addToWantToRead").forEach((e) => {
        e.textContent == "Remove"
          ...
          e.addEventListener("click", () =>
            n(this, null, function* () {
              let a = e.getAttribute("data-id");
              this.alterShelf(a, "want-read-shelf");
            })
          );
      });
  }
  alterShelf(o, t) {
    ...
    if (
      ...
      let i = [];
      s.forEach((l) => {
        l.duplicate == !1 && i.push(l);
      }),
        d(t, i),
        this.getShelvedBooks();
    } else h == !1 && ((a.duplicate = !1), s.push(a)), d(t, s);
  }
}
