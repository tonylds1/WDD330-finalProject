var l = (_, s, e) =>
  new Promise((t, o) => {
    var a = (r) => {
      ...
      i = (r) => (r.done ? t(r.value) : Promise.resolve(r.value).then(a, n));
    i((e = e.apply(_, s)).next());
  });
import {
...
export default class y {
  ...
  getShelvedBooks() {
    return l(this, null, function* () {
      const s = document.getElementById("my_book_lists"),
      ...
      if (
        ...
        (s.innerHTML = this.renderBanner()),
          this.addShelfTitleAndEmptyShelfMessage(s);
      else {
        let t = this.header + " Shelf!";
        c(s, t),
          u("alert", "opening"),
          m(this.bookCount),
  ...
  addShelfTitleAndEmptyShelfMessage(s) {
    u("alert", "opening"),
      g("Nothing is here, try adding a book!", "my_book_lists", !1);
    let t = this.header + " Shelf!";
    c(s, t);
  }
  displayBooksFromShelf(s) {
    return l(this, null, function* () {
      let e = document.querySelector(".count");
      for (const t of this.bookShelf) {
        (this.book = yield v.findBookById(t.id, !1)),
          (this.book.progress = this.readingProgress.get(t));
        try {
        ...
        this.book.volumeInfo.previewLink
          ...
          this.bookCount++,
          (s.innerHTML += this.renderBookDetails()),
        ...
        a.textContent == "Remove"
          ...
          a.addEventListener("click", () =>
            l(this, null, function* () {
              ...
              this.alterShelf(n, t.name),
                this.storageKey != "read-shelf" &&
                  t.name != this.storageKey &&
  ...
  alterShelf(s, e) {
    ...
    } else n == !1 && ((a.duplicate = !1), t.push(a)), h(e, t);
  }
  setReadingProgress() {
    const s = b("reading-progress");
    this.readingProgress = new Map(s);
  }
  handleReadingProgress(s, e) {
    console.log(s, e),
      this.readingProgress.set(s, e),
